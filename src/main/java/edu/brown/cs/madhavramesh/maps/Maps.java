...
public final class Maps {
  ...
  private static KDTree<LocationNode> nodesTree;
   ...
   */
  public static KDTree<LocationNode> getNodesTree() {
    return nodesTree;
  }
   ...
   */
  public static void setNodesTree(KDTree<LocationNode> nodesTree) {
